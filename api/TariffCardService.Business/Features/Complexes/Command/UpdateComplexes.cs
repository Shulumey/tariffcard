...
{
	/// <summary>
	/// Обновление снимка данных текущей тарифной карты.
	/// </summary>
	public static class UpdateComplexes
	{
		/// <inheritdoc />
		...
		public sealed class Handler : IRequestHandler<Command>
		{
			...
			{
				await _complexesProvider.UpdateComplexesAsync(request.Complexes, cancellationToken);
